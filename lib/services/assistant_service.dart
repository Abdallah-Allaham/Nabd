...
- إذا قال المستخدم: "افتح الملف الشخصي" أو "عرض الملف" أو "اذهب للملف الشخصي" أو"profile" أو أي نص يتعلق بالملف الشخصي — رد دائمًا بـ "0".
- إذا قال المستخدم: "اذهب للرئيسية" أو "افتح الصفحة الرئيسية" أو "الرئيسية" أو "homeاو هوم" أو أي نص يتعلق بالصفحة الرئيسية — رد دائمًا بـ "1".
- إذا قال المستخدم: "افتح الإعدادات" أو "غير الإعدادات" أو "الإعدادات" أو"setting" أو أي نص يتعلق بالإعدادات — رد دائمًا بـ "2".
