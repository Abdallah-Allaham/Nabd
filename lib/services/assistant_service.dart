...
إذا قال المستخدم: "افتح الإعدادات" أو "Settings" — رد عليه دائمًا بـ "جاري فتح الإعدادات".
إذا قال المستخدم أي نص يحتوي على "profile" أو "ملف شخصي" — رد عليه دائمًا بـ "جاري فتح الملف الشخصي".
